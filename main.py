...
def button_procent_click():
    memory.append(float(label_workpad["text"]))
    if what_to_do=="-" or what_to_do=="+": 
        label_workpad["text"] =(memory[0]*memory[1])*0.01
    if what_to_do=="*" or what_to_do=="/":
        label_workpad["text"]=memory[1]/100
    memory.clear()
def button_CE_click():
    label_workpad["text"] = "0"
def button_C_click():
...
button1 = Button(text="1", width=10, height=2, command=lambda: digit_click(1)).place(x = 0, y = 250)
button2 = Button(text="2", width=10, height=2, command=lambda: digit_click(2)).place(x = 100, y = 250)
button3 = Button(text="3", width=10, height=2, command=lambda: digit_click(3)).place(x = 200, y = 250)
...
button7 = Button(text="7", width=10, height=2,command=lambda: digit_click(7)).place(x = 0, y = 150)
button8 = Button(text="8", width=10, height=2,command=lambda: digit_click(8)).place(x = 100, y = 150)
button9 = Button(text="9", width=10, height=2, command=lambda: digit_click(9)).place(x = 200, y = 150)
button0 = Button(text="0", width=10, height=2,command=lambda: digit_click(0)).place(x = 100, y = 300)
button_comma = Button(text=".", width=10, height=2,command=comma_click).place(x=200, y=300)
button_negate = Button(text="+/-", width=10, height=2,command=negate_click).place(x=0, y=300)
