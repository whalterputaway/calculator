...
button1 = Button(text="1", width=10, height=2,font=(5), command=lambda: digit_click(1)).place(x = 0, y = 150)
button2 = Button(text="2", width=10, height=2,font=(5), command=lambda: digit_click(2)).place(x = 100, y = 150)
button3 = Button(text="3", width=10, height=2,font=(5), command=lambda: digit_click(3)).place(x = 200, y = 150)
...
button7 = Button(text="7", width=10, height=2,font=(5), command=lambda: digit_click(7)).place(x = 0, y = 250)
button8 = Button(text="8", width=10, height=2,font=(5), command=lambda: digit_click(8)).place(x = 100, y = 250)
button9 = Button(text="9", width=10, height=2, font=(5),command=lambda: digit_click(9)).place(x = 200, y = 250)
